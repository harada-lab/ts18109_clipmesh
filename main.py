...
def main():
    ...
    loop(cfg)
    """
   #mediapy.show_video(mediapy.read_video(os.path.join(cfg["path"],'y_video.mp4')),title=cfg["text_prompt"])
    m = trimesh.load(os.path.join(cfg["path"], 'meshes', 'mesh_0', 'mesh.obj'))
    im = Image.open(os.path.join(cfg["path"], 'meshes', 'mesh_0', 'texture_kd.png'))
